...
INSERT INTO USUARIOS (DNI,NOMBRE,APELLIDO,TELEFONO,DIRECCION,CORREO,CLAVE,ID_RO)
VALUES ('99999999','DIEGO','ANDRES','999999999','LOS PALETAS 555','diegogc@gmail.com','clientegutarra',1);
...
INSERT INTO EDITORIALES (DESCRIPCION) VALUES ('BDA LIBROS');
...
UPDATE LIBROS SET ID_ED = 2 where ID_LI=2;
...
INSERT INTO LIBROS (ISBN,SKU,TITULO,DESCRIPCION,PRECIO,CANTIDAD,PAGINAS,IMAGEN,ID_AU,ID_ED,ID_CAT)
VALUES ('96319870000000','96319870000000','COLMILLO BLANCO','-',
70.00,0,120,'https://res.cloudinary.com/dlvfkjwpg/image/upload/v1638044619/samples/ecommerce/Libros/colmillo-blanco-24_ipxx9d.jpg',3,1,3);
...
/*SELECT  ID_LI, TITULO, CANTIDAD, PRECIO
FROM LIBROS
WHERE CANTIDAD != '0';*/
...
/*SELECT C.DESCRIPCION AS CATEGORIA, COUNT(*) AS CANTIDAD_LIBROS
FROM LIBROS AS L
